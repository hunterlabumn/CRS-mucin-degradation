...
## RSubread Count Data
```{r}
countsSamples <- readRDS("../data/subread/counts.rds") %>%
  select(-contains("MMM"))
```
## Sample Data
```{r}
coldataSamples <- read_tsv("../data/samplesheet.txt") %>%
...
export to csv
```{r}
write_csv(sig_res_LRT_samples, path="../data/DESeq2/LRT/sig_res_LRT_samples.csv")
```
...
export to csv
```{r}
write_csv(sig_res_LRT_samples_lfc1, path = "../data/DESeq2/LRT/sig_res_LRT_samples_lfc1.csv")
```
...
```
```{r}
ggsave(heatmapLRTVarSamples, filename = "../figures/DESeq2/heatmaps/LRT_top100var_heatmap.pdf",
       device = "pdf",
       height = 15,
       width = 10)
```
...
```{r}
ggsave(heatmapLRTPubSamples, filename = "../figures/DESeq2/heatmaps/heatmap_pubGenes.pdf",
       device = "pdf",
       height = 4.5,
       width = 2)
```
