...
refLocal <- paste0(path,"data/GCF_ASM1346v1/")
refLocal
```
...
```{r}
align(index="../data/GCF_ASM1346v1/subread_indexes/ASM1346v1", 
...
```{r}
gtfDF <- read_tsv("../data/GCF_ASM1346v1/GCF_000013465.1_ASM1346v1_genomic.txt", skip = 5)
gtfDF
```
...
let's look at the feature table text file  to see what kind of data we can include in our annotation file. This will become usefull when we're looking at genes of interest/plotting.
```{r}
featureTable <- read_tsv((file = "../data/GCF_ASM1346v1/GCF_000013465.1_ASM1346v1_feature_table.txt")) 
