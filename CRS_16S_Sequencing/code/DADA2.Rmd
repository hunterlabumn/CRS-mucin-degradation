...
```{r}
# File parsing
path_1 <- "../data/fastq/RUN1_AE51B/cutadapt"
...
```{r}
# File parsing
path_2 <- "../data/fastq/RUN2_AH2MV/cutadapt"
...
```{r}
# File parsing
path_3 <- "../data/fastq/RUN3_AHFM2/cutadapt"
...
```{r}
# File parsing
path_4 <- "../data/fastq/RUN4_AN2A6/cutadapt"
...
```{r}
# File parsing
path_5 <- "../data/fastq/RUN5_CCVK7/cutadapt"
...
track_all <- rbind(track_1, track_2, track_3, track_4, track_5)
