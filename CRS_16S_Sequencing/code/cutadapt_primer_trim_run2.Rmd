---
title: "Cutadapt Primer Trimming - Run 1 (AH2MV)"
---
...
```{r}
path <- "../data/fastq/RUN2_AH2MV"  ## CHANGE ME to the directory containing the fastq files.
list.files(path)
```
...
REV <- "GGACTACHVGGGTWTCTAAT" # This primer sequence will reproduce the results from the original analysis
```
